...
export WORKER_ID="${WORKER_ID:-${PLUM_INSTANCE_ID:-fsl-destroy-dev}}"
...
export PLUM_INSTANCE_ID="${PLUM_INSTANCE_ID:-fsl-destroy-001}"
export PLUM_APP_NAME="${PLUM_APP_NAME:-FSL_Destroy}"
export PLUM_APP_VERSION="${PLUM_APP_VERSION:-1.0.0}"

exec "${SCRIPT_DIR}/FSL_Destroy"
