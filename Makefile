...
examples_Sim_RoutePlan:
	...
	@echo "✅ Sim_RoutePlan built: examples-local/Sim_RoutePlan/bin/Sim_RoutePlan"
...
examples_Sim_NaviControl:
	...
	@echo "✅ Sim_NaviControl built: examples-local/Sim_NaviControl/bin/Sim_NaviControl"

examples_Sim_Sonar:
	@echo "Building Sim_Sonar (qmake)..."
	@cd examples-local/Sim_Sonar && mkdir -p build && cd build && $(QMAKE) CONFIG+=release .. && $(MAKE)
	@echo "✅ Sim_Sonar built: examples-local/Sim_Sonar/bin/Sim_Sonar"
...
examples_Sim_TargetHit:
	...
	@echo "✅ Sim_TargetHit built: examples-local/Sim_TargetHit/bin/Sim_TargetHit"
