...
func handleTaskByID(w http.ResponseWriter, r *http.Request) {
    ...
    case http.MethodPatch:
        var body struct{ Name string `json:"name"`; Labels map[string]string `json:"labels"` }
        if err := jsonNewDecoder(w, r, &body); err != nil { return }
...
func jsonNewDecoder(w http.ResponseWriter, r *http.Request, v any) error {
    ...
    if err := dec.Decode(v); err != nil { http.Error(w, "bad request", http.StatusBadRequest); return err }
    return nil
}
