...
func handleOpenAPI(w http.ResponseWriter, r *http.Request) {
	...
	doc := OA{
		...
		"paths": OA{
			...
			"/v1/tasks": OA{
				"get":  OA{"summary": "List tasks", "responses": OA{"200": OA{"description": "OK", "content": OA{"application/json": OA{"schema": OA{"type": "array", "items": OA{"$ref": "#/components/schemas/TaskDTO"}}}}}}},
				"post": OA{"summary": "Create task", "requestBody": OA{"required": true, "content": OA{"application/json": OA{"schema": OA{"$ref": "#/components/schemas/CreateTaskRequest"}}}}, "responses": OA{"200": OA{"description": "OK", "content": OA{"application/json": OA{"schema": OA{"type": "object", "properties": OA{"taskId": OA{"type": "string"}, "instances": OA{"type": "array", "items": OA{"type": "string"}}}}}}}}},
			},
			"/v1/tasks/{id}": OA{
				"get":    OA{"summary": "Get task", "parameters": []any{OA{"name": "id", "in": "path", "required": true, "schema": OA{"type": "string"}}}, "responses": OA{"200": OA{"description": "OK", "content": OA{"application/json": OA{"schema": OA{"type": "object", "properties": OA{"task": OA{"$ref": "#/components/schemas/Task"}, "assignments": OA{"type": "array", "items": OA{"$ref": "#/components/schemas/Assignment"}}}}}}}}},
				"patch":  OA{"summary": "Patch task labels", "parameters": []any{OA{"name": "id", "in": "path", "required": true, "schema": OA{"type": "string"}}}, "requestBody": OA{"required": true, "content": OA{"application/json": OA{"schema": OA{"$ref": "#/components/schemas/TaskPatch"}}}}, "responses": OA{"204": OA{"description": "No Content"}, "200": OA{"description": "Labels updated", "content": OA{"application/json": OA{"schema": OA{"type": "object", "properties": OA{"taskId": OA{"type": "string"}}}}}}}},
		...
		"components": OA{"schemas": OA{
			...
			"TaskDTO":                OA{"type": "object", "properties": OA{"taskId": OA{"type": "string"}, "name": OA{"type": "string"}, "labels": OA{"type": "object", "additionalProperties": OA{"type": "string"}}, "instances": OA{"type": "integer"}}},
			"Task":                   OA{"type": "object", "properties": OA{"taskId": OA{"type": "string"}, "name": OA{"type": "string"}, "labels": OA{"type": "object", "additionalProperties": OA{"type": "string"}}}},
			"TaskPatch":              OA{"type": "object", "properties": OA{"name": OA{"type": "string"}, "labels": OA{"type": "object", "additionalProperties": OA{"type": "string"}}}},
			"CreateTaskEntry":        OA{"type": "object", "properties": OA{"artifactUrl": OA{"type": "string"}, "startCmd": OA{"type": "string"}, "replicas": OA{"type": "object", "additionalProperties": OA{"type": "integer"}}}, "required": []any{"artifactUrl", "replicas"}},
			"CreateTaskRequest":      OA{"type": "object", "properties": OA{"name": OA{"type": "string"}, "labels": OA{"type": "object", "additionalProperties": OA{"type": "string"}}, "entries": OA{"type": "array", "items": OA{"$ref": "#/components/schemas/CreateTaskEntry"}}, "artifactUrl": OA{"type": "string"}, "startCmd": OA{"type": "string"}, "replicas": OA{"type": "object", "additionalProperties": OA{"type": "integer"}}}, "required": []any{"name"}},
			"Assignment":             OA{"type": "object", "properties": OA{"instanceId": OA{"type": "string"}, "taskId": OA{"type": "string"}, "nodeId": OA{"type": "string"}, "desired": OA{"type": "string"}, "artifactUrl": OA{"type": "string"}, "startCmd": OA{"type": "string"}}},
			"AssignmentItem":         OA{"type": "object", "properties": OA{"instanceId": OA{"type": "string"}, "taskId": OA{"type": "string"}, "desired": OA{"type": "string"}, "artifactUrl": OA{"type": "string"}, "startCmd": OA{"type": "string"}, "phase": OA{"type": "string"}, "healthy": OA{"type": "boolean"}, "lastReportAt": OA{"type": "integer", "format": "int64"}}},
